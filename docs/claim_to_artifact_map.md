...
|---|---|---|---|---|
| **Figure 1** | Per-coefficient RMS spectrum of JGGRX_1800F with power-law fits over the observationally dominated band (n∈[10,600])… | `fig_spectrum.pdf` | `make_figures_r1.py` | R1 |
