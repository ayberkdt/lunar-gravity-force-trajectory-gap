...
|---|---|---|---|
| Field, timing, budget and long-arc campaigns (R8, R14, R15, R16, R17, and the R18–R23 campaigns that reuse their trajectories) | 3.12.1 | NumPy 2.2.6, SciPy 1.14.1, Numba 0.63.1 | 25 |
...
The numerical kernel is pinned across R10–R23 to one source snapshot,
