...
manifests and the drivers needed to audit every reported result. All 428
...
|---|---|---|
| Field, timing, budget and long-arc campaigns (R8, R14–R17, and the R18–R25 and R28–R39 campaigns reusing their trajectories) | 3.12.1 | NumPy 2.2.6, SciPy 1.14.1, Numba 0.63.1 |
...
| `scripts/` | 231 campaign drivers, analysis passes, table builders and figure generators |
| `metrics/` | 320 result records, 89 generated LaTeX tables, preregistrations, and the 24 campaign manifests `r10`–`r39`; per-orbit case configurations in `*_cases/` |
...
This walks all 24 manifests and compares them against the files as they stand.
Digests of everything under `src/` are in
[`docs/SOURCE_MANIFEST.md`](docs/SOURCE_MANIFEST.md).

At the current state the audit reports 428 digests matching, no file missing
