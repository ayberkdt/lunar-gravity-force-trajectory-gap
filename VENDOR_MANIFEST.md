# Vendored Lunaris modules

SHA-256 of each file as copied from the Lunaris working tree that produced the published results.
...
| `src/lunaris/core/__init__.py` | `trimmed initializer (not upstream)` |
| `src/lunaris/core/propagation/__init__.py` | `trimmed initializer (not upstream)` |
